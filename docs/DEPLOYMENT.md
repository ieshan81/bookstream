...
3. Use the following build settings:
   ...
   - **Build command**: `npm install && npx prisma generate` (Netlify installs dependencies and generates the Prisma client).
   - **Publish directory**: `public` (required by Netlify even though this repo only serves functions).
